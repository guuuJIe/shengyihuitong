        ...
        if (@available(iOS 13.0, *)) {
            for (UIWindowScene *windowscene in [UIApplication sharedApplication].connectedScenes) {
                if ([windowscene activationState] == UISceneActivationStateForegroundActive) {
                    win = windowscene.windows.lastObject;
                    break;
                }
            }
        } else {
...
//        LOTAnimationView *animate = [LOTAnimationView animationNamed:@"loading"];
////        animate.frame = CGRectMake(0, 0, 60, 60);
//        animate.backgroundColor = [UIColor clearColor];
//        animate.loopAnimation = true;
//        hud.mode = MBProgressHUDModeCustomView;
//        hud.customView = animate;
        hud.removeFromSuperViewOnHide = YES;
        gloomyView.frame = view ? CGRectMake(0, 0, view.frame.size.width, view.frame.size.height):
        kDefaultRect;
...
//
        ...
        hud.mode = MBProgressHUDModeCustomView;
        UIImage *image = [[UIImage imageNamed:@"anim_01.png"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
//        hud.minSize = CGSizeMake(60, 60);
        UIImageView* mainImageView= [[UIImageView alloc] initWithImage:image];
        mainImageView.frame = CGRectMake(0, 0, 40, 40);
        mainImageView.animationImages = [NSArray arrayWithObjects:
                                         [UIImage imageNamed:@"anim_01.png"],
                                         [UIImage imageNamed:@"anim_02.png"],
                                         [UIImage imageNamed:@"anim_03.png"],[UIImage imageNamed:@"anim_04.png"],nil];
