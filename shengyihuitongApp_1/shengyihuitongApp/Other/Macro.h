...
#define mytableName @"downloadTable"//主表
#define childDownloadTable @"childDownloadTable"//附表内容
...
#define LabelFont14 [UIFont systemFontOfSize:16]
#define LabelFont13 [UIFont systemFontOfSize:15]
#define LabelFont15 [UIFont systemFontOfSize:17]
#define LabelFont12 [UIFont systemFontOfSize:14]
#define LabelFont11 [UIFont systemFontOfSize:13]
#define LabelFont10 [UIFont systemFontOfSize:12]
#define LabelFont9  [UIFont systemFontOfSize:11]
#define LabelFont18 [UIFont systemFontOfSize:20]
#define LabelFont16 [UIFont systemFontOfSize:18]
