...
- (void)setupUI{
    ...
    [self.coverImage mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.size.mas_equalTo(CGSizeMake(120*AdapterScal, 90*AdapterScal));
...
-(UILabel *)priceLbl
{
    if(!_priceLbl)
    {
        ...
        _priceLbl = [UILabel commonLabelWithtext:@"标题" color:fenseColor font:LabelFont12 textAlignment:NSTextAlignmentCenter];
...
- (UIButton *)playedBtn{
    if (!_playedBtn) {
        ...
        [_playedBtn setImage:[UIImage imageNamed:@"eye"] forState:0];
    }
