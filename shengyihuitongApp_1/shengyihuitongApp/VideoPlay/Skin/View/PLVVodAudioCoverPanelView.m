...
//    [self.audioCoverContainerBackgroundImageView sd:[NSURL URLWithString:url] placeholder:nil];
//    [self.audioCoverImage yy_setImageWithURL:[NSURL URLWithString:url] placeholder:nil];
    [self.audioCoverImage sd_setImageWithURL:URL(url)];
    [self.audioCoverContainerBackgroundImageView sd_setImageWithURL:URL(url)];
}
