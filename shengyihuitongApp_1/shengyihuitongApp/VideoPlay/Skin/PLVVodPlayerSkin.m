...
- (IBAction)backAction:(UIButton *)sender {
    ...
    self.delegatePlayer.view.hidden = true;
...
- (IBAction)playBackAct:(id)sender {
    [[NSNotificationCenter defaultCenter] postNotificationName:@"videoPlayBack" object:nil];
}

- (IBAction)playNextAct:(id)sender {
    
    [[NSNotificationCenter defaultCenter] postNotificationName:@"videoPlayNext" object:nil];
}
